...
const ContactController = require("../../controllers/otherpages/contactController")

route.post("/", async (req, res) => {
  try {
    // Save contact in DB
    const newContact = await ContactController.createContact(req, res, true);
