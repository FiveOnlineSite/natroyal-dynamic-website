...
const Buttons = () => {
  ...
  const [technicalSpecification, setTechnicalSpecification] = useState({file: ""});
  ...
  useEffect(() => {
   ...
   const handleSubmit = async (e) => {
    ...
    formDataToSend.append("technical_specification", technicalSpecification.file);
    formDataToSend.append("installation_maintenance", installationMaintenance || "");
    if (brochure?.file) {
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="theme-form">
                <label>Technical Specification</label>
                 <input 
                   ...
                   onChange={(e) => setTechnicalSpecification({ ...technicalSpecification,
             ...
             <div className="col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="theme-form">
               ...
               <a href={`${process.env.REACT_APP_API_URL}${brochure.filepath}`}>
                📄 View PDF - {brochure.filename}
              </a>
