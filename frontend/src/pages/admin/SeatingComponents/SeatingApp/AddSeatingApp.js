...
const AddSeatingApp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${apiUrl}/api/seating-application`, formData, {
        headers: {
      ...
      navigate("/admin/seating-applications");
              toast.success("Seating component application created successfully!");
