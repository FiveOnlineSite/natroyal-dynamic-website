      ...
      <section className="landing-banner-section pb-5">
        <div className="slide-container">
          <div className="poster-container">
            <img
              // src="/images/banners/Frame 3.png"
              src="https://res.cloudinary.com/dcmdihrzp/image/upload/v1751277253/Frame_3_kuxurf.png"
              alt="Poster"
            ...
            <div className="banner-text">
              <h1 className="banner-title">
                {" "}
                Where Softness Meets Strength – Premium Knit Fabrics
              </h1>
          ...
          <div className="row align-items-start justify-content-center">
            <div className="col-lg-10 mt-lg-0 mt-4">
              <h6 className="subtitle">
                Knit Fabrics – Where Flexibility Meets Comfort<span></span>
              </h6>
              <h2 className="title">
                <span className="yellow-title"> About</span> Knit Fabrics
              </h2>
