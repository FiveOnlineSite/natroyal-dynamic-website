    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/admin" element={<AdminRoutes />}>
          ...
          <Route path="edit/vinyl-applications/:id" element={<EditVinylApp />} />

           <Route path="vinyl-application-content" element={<VinylAppContent />} />
          <Route path="add/vinyl-application-content" element={<AddVinylAppContent />} />
          <Route path="edit/vinyl-application-content/:id" element={<EditVinylAppContent />} />


          <Route path="vinyl-products" element={<VinylProduct />} />
          <Route path="add/vinyl-products" element={<AddVinylProduct />} />
          <Route path="edit/vinyl-products/:id" element={<EditVinylProduct />} />

          <Route path="vinyl-product-content" element={<VinylProductContent />} />
          <Route path="add/vinyl-product-content" element={<AddVinylProductContent />} />
          <Route path="edit/vinyl-product-content/:id" element={<EditVinylProductContent />} />

          <Route path="vinyl-product-variants" element={<VinylProductVariant />} />
          <Route path="add/vinyl-product-variants" element={<AddVinylProductVariant />} />
          <Route path="edit/vinyl-product-variants/:_id" element={<EditVinylProductVariant />} />
